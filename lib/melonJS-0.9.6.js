...
(function($) {
	...
	/** @scope me.AnimationSheet.prototype */
	{
		...
		init : function(x, y, image, spritewidth, spriteheight, spacing, margin) {
			...
			this.renderable.addAnimation("default", null);
			// set as default
		 ...
		 * // slower animation
		 * this.renderable.addAnimation ("roll", [7,8,9,10], 10);
		 */
		 ...
		 * this.renderable.setCurrentAnimation("die", function(){me.game.remove(this)});
		 **/
			...
			if (this.visible && !this.animationpause && (this.fpscount++ > this.current.animationspeed)) {
				...
				if ((this.current.idx == 0) && this.resetAnim)  {
					...
					if (typeof(this.resetAnim) == "string")
						this.renderable.setCurrentAnimation(this.resetAnim);
